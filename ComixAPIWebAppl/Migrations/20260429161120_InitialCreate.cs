    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Comics_pkey", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Comics_Genres",
                        column: x => x.GenreId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comics_Publishers",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("ComicAuthors_pkey", x => new { x.ComicId, x.AuthorId });
                    table.ForeignKey(
                        name: "FK_ComicAuthors_Authors",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComicAuthors_Comics",
                        column: x => x.ComicId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_ComicId",
                table: "CartItems",
                column: "ComicId");

            migrationBuilder.CreateIndex(
                name: "UQ_CartItems_Cart_Comic",
                table: "CartItems",
                columns: new[] { "CartId", "ComicId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ_Carts_AccountId",
                table: "Carts",
                column: "AccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ComicAuthors_AuthorId",
                table: "ComicAuthors",
                column: "AuthorId");
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_Reviews_Comic_Account",
                table: "Reviews",
                columns: new[] { "ComicId", "AccountId" },
                unique: true);
